...
//
//	public GSDMM_backup1(int K, double alpha, double beta, int iterNum, String dataset) {
//		this.K = K;
//		this.alpha = alpha;
//		this.beta = beta;
...
//		model.setMultiThread(documentSet,thread_num,useIndex);
